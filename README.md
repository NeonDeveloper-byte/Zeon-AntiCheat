# Zeon Authorization List

This repository is for Roblox game developers who want to integrate **Zeon Anticheat** into their experiences.  
Only approved games are authorized to run the script.

<img width="1026" height="172" alt="RxK74ro" src="https://github.com/user-attachments/assets/0cf9d9ef-277e-428f-96e1-07ef4572cb5b" />
...
## 🚫 Unauthorized Use
- Games not listed here are not authorized to run Zeon Anticheat.  
...
## 🔧 How It Works
- Zeon Anticheat checks the **Place ID** of the running game.  
...
To request authorization, you’ll need your game’s **Place ID**. [Join our Discord Server]()  
